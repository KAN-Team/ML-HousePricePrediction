...
print("-----------------------------------------------------------\n")
print("accuracy for logistic regression classifier: {}%".format(accuracy))
print("Training Time for logistic regression classifier: {}s".format(logistic_end_time - logistic_start_time))
print('MSE for logistic regression classifier: ', metrics.mean_squared_error(np.asarray(y_test), predictions))
